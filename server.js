...
router.route('/projects/:projectId/templates/:patherId/childs')  
  .get(routes.auth.isAuthenticated, routes.templates.allByProjectAndPather); // all templates by user and project
